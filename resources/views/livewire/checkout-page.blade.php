			...
			<div class="md:col-span-12 lg:col-span-8 col-span-12">
				...
				<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
					...
					<div class="mb-6">
						...
						<div class="grid grid-cols-2 gap-4">
							<div>
								...
								<input required wire:model="first_name"
							...
							<div>
								...
								<input required wire:model="last_name"
						...
						<div class="mt-4">
							...
							<input required wire:model="phone"
						...
						<div class="mt-4">
							...
							<input required wire:model="street_address"
						...
						<div class="mt-4">
							...
							<input required wire:model="city"
						...
						<div class="grid grid-cols-2 gap-4 mt-4">
							<div>
								...
								<input required wire:model="state"
							...
							<div>
								...
								<input required wire:model="zip_code"
					...
					<ul class="grid w-full gap-6 md:grid-cols-2">
						<li>
							<input wire:model='payment_method' class="hidden peer" id="cod" name="payment_method"
						...
						<li>
							<input wire:model='payment_method' class="hidden peer" id="duitnow" name="payment_method"
								type="radio" value="duitnow">
							<label
								class="inline-flex items-center justify-between w-full p-5 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700"
								for="duitnow">
								<div class="block">
			...
			<div class="md:col-span-12 lg:col-span-4 col-span-12">
				<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
					...
					<div class="flex justify-between mb-2 font-bold">
						...
						<span>
							{{Number::currency($grand_total, 'MYR')}}
						</span>
					</div>
					<div class="flex justify-between mb-2 font-bold">
						<span>
						...
						<li class="py-3 sm:py-4">
							<div class="flex items-center">
								...
								<div
									...
									{{Number::currency($item['total_amount'], 'MYR')}}
								</div>
							</div>
						</li>
						@endforeach
