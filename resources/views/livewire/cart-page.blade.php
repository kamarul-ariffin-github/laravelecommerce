  ...
  <div class="container mx-auto px-4">
    ...
    <div class="flex flex-col md:flex-row gap-4">
      <div class="md:w-3/4">
        <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
          <table class="w-full">
            ...
            <tbody>
              ...
              @empty
              <tr>
                <td colspan="5" class="text-center py-4 text-3xl font-semibold text-slate-500">Your cart is empty</td>
              </tr>
        ...
        <a wire:navigate href="/products" class=" bg-green-600 hover:bg-green-500 text-white py-2 px-4 rounded-lg mt-4 text-center">Continue Shopping</a>
      </div>
      <div class="md:w-1/4">
        <div class="bg-white rounded-lg shadow-md p-6">
          ...
          <div class="flex justify-between mb-2">
            <span>Taxes</span>
            <span>{{Number::currency(0, 'MYR')}}</span>
          </div>
          <div class="flex justify-between mb-2">
            <span>Shipping</span>
            <span>{{Number::currency(0, 'MYR')}}</span>
          ...
          @if ($cart_items)
          <a wire:navigate href="/checkout" class="block bg-blue-500 text-white py-2 px-4 rounded-lg mt-4 w-full text-center disabled:opacity-50 disabled:pointer-events-none">Checkout</a>
          @endif
        </div>
      </div>
    </div>
