      ...
      <div id="navbar-collapse-with-animation"
        ...
        <div
          ...
          <div
            ...
            <a wire:navigate
              class=" {{ request()->is('/') ? 'text-blue-600 dark:text-blue-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600' : 'text-gray-500 hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600' }} font-medium py-3 md:py-6 "
              href="/" aria-current="page">Home</a>

            <a wire:navigate
              class=" {{ request()->is('categories') ? 'text-blue-600 dark:text-blue-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600' : 'text-gray-500 hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600'}} font-medium py-3 md:py-6 "
              href="/categories">
              Categories
            </a>

            <a wire:navigate
              class=" {{ request()->is('products') ? 'text-blue-600 dark:text-blue-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600' : 'text-gray-500 hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600'}} font-medium py-3 md:py-6 "
              href="/products">
              Products
            </a>

            <a wire:navigate
              class=" {{ request()->is('cart') ? 'text-blue-600 dark:text-blue-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600' : 'text-gray-500 hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600'}} font-medium flex items-center py-3 md:py-6 "
              href="/cart">
            ...
            <div
              ...
              <div
                ...
                <a wire:click='logout' class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                  href="#">
                  Logout
                </a>
              </div>
